...
final class ANOperationsTests: XCTestCase {
    ...
    static var allTests = [
        ...
        ("testStandardOperation", testStandardOperation),
        ("testBlockOperation_noConditions_noDependencies", testBlockOperation_noConditions_noDependencies),
        ("testOperation_withPassingCondition_noDependencies", testOperation_withPassingCondition_noDependencies),
        ("testOperation_withFailingCondition_noDependencies", testOperation_withFailingCondition_noDependencies),
        "testOperation_withPassingCondition_andConditionDependency_noDependencies", (testOperation_withPassingCondition_andConditionDependency_noDependencies),
        ("testOperation_noCondition_hasDependency", testOperation_noCondition_hasDependency),
        ("testGroupOperation", testGroupOperation),
        ("testGroupOperation_cancelBeforeExecuting", testGroupOperation_cancelBeforeExecuting),
        ("testDelayOperation", testDelayOperation),
        ("testDelayOperation_With0", testDelayOperation_With0),
        ("testDelayOperation_WithDate", testDelayOperation_WithDate),
        ("testMutualExclusion", testMutualExclusion),
        ("testConditionObserversCalled", testConditionObserversCalled),
        ("testSilentCondition_failure", testSilentCondition_failure),
        ("testNegateCondition_failure", testNegateCondition_failure),
        ("testNegateCondition_success", testNegateCondition_success),
        ("testNoCancelledDepsCondition_aDepCancels", testNoCancelledDepsCondition_aDepCancels),
        ("testOperationRunsEvenIfDepCancels", testOperationRunsEvenIfDepCancels),
        ("testCancelledOperationLeavesQueue", testCancelledOperationLeavesQueue),
        ("testCancelOperation_cancelBeforeStart", testCancelOperation_cancelBeforeStart),
        ("testCancelOperation_cancelAfterStart", testCancelOperation_cancelAfterStart),
        ("testBlockObserver", testBlockObserver),
        ("testTimeoutObserver", testTimeoutObserver),
        ("testNoCancelledDepsCondition_aDepCancels_inGroupOperation", testNoCancelledDepsCondition_aDepCancels_inGroupOperation),
        ("testOperationCompletionBlock", testOperationCompletionBlock),
        ("testBlockOperationCanBeCancelledWhileExecuting", testBlockOperationCanBeCancelledWhileExecuting),
        ("testDelayOperationIsCancellableAndNotFinishedTillDelayTime", testDelayOperationIsCancellableAndNotFinishedTillDelayTime),
        ("testConcurrentOpsWithBlockingOp", testConcurrentOpsWithBlockingOp),
        ("testMoveFromPendingToFinishingByWayOfCancelAfterEnteringQueue", testMoveFromPendingToFinishingByWayOfCancelAfterEnteringQueue),
        ("testOperationQueueNotGettingStuck", testOperationQueueNotGettingStuck),
